...
public class ExhibitManagementController {
    ...
    @FXML
    private Button updateExhibitButton;

    @FXML
    private Button deleteExhibitButton;
    ...
    private void initialize() {
        ...
        // Load status options in ComboBox
        statusComboBox.setItems(FXCollections.observableArrayList(
                "on_display", "in_storage", "under_maintenance", "loaned_out", "in_transit", "reserved", "damaged"
        ));
    ...
    private void updateExhibit() {
        ...
        try (Connection conn = DatabaseHandler.getConnection()) {
            ...
            stmt.setString(3, statusComboBox.getValue());
    ...
    @FXML
    private void goBack() {
        Stage stage = (Stage) exhibitTable.getScene().getWindow();
        stage.close();
    }
}
